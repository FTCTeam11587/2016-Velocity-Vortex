...
@Autonomous(name="AutoDrive: Sleep_Near_CapBall_CornerPark_BN_Enc", group="AutoDrive")

public class Blue_Near_Sleep_CapBall_CornerPark extends LinearOpMode {
		...
		public void runOpMode() throws InterruptedException {
			...
			// Dont use the word "servo" in the name.  The install scripts parse for servo stuff a little differently
			// than the motors.
			...
			sleep(10000);
			encoderDrive(DRIVE_SPEED, 12, 12, 10000);	//Drive forward to 48,12
			encoderTurn(TURN_SPEED, -90, 10000);	//90 degree left turn
			encoderDrive(DRIVE_SPEED, 12, 12, 10000);	//Drive forward to 60,12
			encoderTurn(TURN_SPEED, 90, 10000);		//90 degree right turn
			encoderDrive(DRIVE_SPEED, 48, 48, 10000);	//Drive forward to 60,60
			encoderDrive(DRIVE_SPEED, -42,-42, 10000);       //Back up to 18,60
			encoderTurn(TURN_SPEED, -90, 10000);	 //Turn 90 degrees left
			encoderDrive(DRIVE_SPEED, -42, -42, 10000);      //Back up to 18,18
			encoderTurn(TURN_SPEED, 45, 10000);		 //Turn to align with the corner vortex
			encoderDrive(DRIVE_SPEED, -24, -24, 10000);      //Back into corner
		}
