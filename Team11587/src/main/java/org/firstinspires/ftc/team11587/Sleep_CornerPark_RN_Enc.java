...
@Autonomous(name="AutoDrive: Sleep_CornerPark_RN_Enc", group="AutoDrive")

public class Sleep_CornerPark_RN_Enc extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		sleep(10000);
		encoderDrive(DRIVE_SPEED, 48, 48, 10000);        //Start @ 48,0
		encoderTurn(TURN_SPEED, 45.0, 10000);        //Pivot tail towards corner
		encoderDrive(DRIVE_SPEED, -60, -60, 10000);        //Back into corner
	}
