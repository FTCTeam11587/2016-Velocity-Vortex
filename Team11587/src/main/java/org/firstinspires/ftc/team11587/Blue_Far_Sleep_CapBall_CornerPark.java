...
@Autonomous(name="AutoDrive: Sleep_CapBall_CornerPark_BF_Enc", group="AutoDrive")

public class Blue_Far_Sleep_CapBall_CornerPark extends LinearOpMode {
	...
	static final double WHEEL_DIAMETER_INCHES = 3.75; //95mm diameter;
	...
	public void runOpMode() throws InterruptedException {
		...
		sleep(10000);
		encoderDrive(DRIVE_SPEED, 60, 60, 10000);        //Start @ 0,72 and drive forward to 60,72 to hit cap ball
		encoderDrive(DRIVE_SPEED, -42,-42, 10000);       //Back up to 18,72
		encoderTurn(TURN_SPEED, -90, 10000);	 //Turn 90 degrees left
		encoderDrive(DRIVE_SPEED, -54, -54, 10000);      //Back up to 18,18
